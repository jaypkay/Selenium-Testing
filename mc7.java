/* Basic Data Driven Driver - Oct 2011
Uses apache.poi to for Datasheet read & write 
...
public class mc7 extends SeleneseTestCase {
	...
	public void setUp() throws Exception {
		...
		xPath = "C:/SeleniumData/mc-data.xls";
		xPath_res = "C:/SeleniumData/mc-data-result.xls";
		xlRead(xPath); // 
	}
	@Test
	public void testMc1() throws Exception {
		...
		for (i=1; i<xRows; i=i+1){
			...
			if (vExecute.equals("Y")) {
				...
				// ----- selenium.type("param[loanamount]", vLoan);
